...
class ParkingCostsFrontendContracts(unittest.TestCase):
    def test_parking_costs_modal_uses_segmented_sections(self):
        ...
        self.assertIn("button.tabIndex = isActive ? 0 : -1;", ui_js)
        self.assertIn("['ArrowLeft', 'ArrowRight', 'Home', 'End']", ui_js)
        self.assertIn("focusWithoutScroll(tabs[nextIndex]);", ui_js)
