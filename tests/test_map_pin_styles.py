...
class MapPinStyleContracts(unittest.TestCase):
    def test_vehicle_pin_uses_group_insurance_status_as_ring(self):
        ...
        self.assertIn("const VEHICLE_STATUS_FILTER_INSURED = 'insured';", vehicle_layer_js)
        ...
        self.assertIn('data-vehicle-status-filter="insured"', html)
        ...
        self.assertIn('class="map-pin-legend-item map-pin-legend-filter"', html)
        ...
        self.assertIn(".map-pin-legend-filter.is-active", layer_css)
        ...
        self.assertIn("layers.vehicleStatusFilterInsured", html + i18n_js)
